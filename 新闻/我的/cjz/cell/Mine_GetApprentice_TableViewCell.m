...
-(void)initView{
    ...
    UIImageView* img = [[UIImageView alloc] initWithFrame:CGRectMake(kWidth(16), kWidth(16), kWidth(32), kWidth(32))];
    [img.layer setCornerRadius:kWidth(32)/2];
    ...
    time.font = [UIFont fontWithName:@"SourceHanSansCN-Regular" size:12];
    m_time = time;
    
    UIImageView* img_next = [[UIImageView alloc] initWithFrame:CGRectMake(SCREEN_WIDTH-kWidth(16)-kWidth(16), kWidth(24), kWidth(16), kWidth(16))];
    ...
    lable_money.font = [UIFont systemFontOfSize:font(14)];
    m_money = lable_money;
    ...
    UIView* line = [[UIView alloc] initWithFrame:CGRectMake(0, kWidth(64)-1, SCREEN_WIDTH, 1)];
...
-(void)setModel:(Mine_GetApprentice_model *)model{
    ...
    m_time.text = [[TimeHelper share] GetDateFromString_YYYYMMDD:model.time];
