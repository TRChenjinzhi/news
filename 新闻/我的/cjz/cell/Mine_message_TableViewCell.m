...
-(void)initView{
    ...
    //title
    UILabel* title_lable = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMaxX(icon_imgV.frame)+kWidth(8), kWidth(16), kWidth(150), kWidth(16))];
    title_lable.textColor = [[ThemeManager sharedInstance] MineMessageCellTitleColor];
    title_lable.font = [UIFont boldSystemFontOfSize:kWidth(16)];
    title = title_lable;
...
-(void)setModel:(Mine_message_model *)model{
    ...
    CGFloat height = [LabelHelper GetLabelHight:kFONT(14) AndText:model.subTitle AndWidth:subTitle.frame.size.width];
    ...
    NSLog(@"CGRectGetMaxY(subTitle.frame):%f",CGRectGetMaxY(subTitle.frame));
