//
//  Mine_Total_ChangeMoney_ViewController.m
//  新闻
//
...
@interface Mine_Total_ChangeMoney_ViewController ()

@end

@implementation Mine_Total_ChangeMoney_ViewController{
...
-(void)initView{
    ...
    [img_view setImage:[UIImage imageNamed:@"ic_empty_take"]];
